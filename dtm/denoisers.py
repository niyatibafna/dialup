...
class Denoiser:
    def __init__(self, lrl, hrl, bilingual_lexicon_path):
        self.lrl = lrl
        self.hrl = hrl
        self.tag2wordlist = self.get_tag2wordlist()
        self.lrl_to_hrl = self.get_bilingual_lexicon(bilingual_lexicon_path)
        
    def get_tag2wordlist(self):
        '''Get tag2wordlist from the JSON file'''
        with open(ud_wordlist_paths[self.hrl]) as f:
    ...
    def get_bilingual_lexicon(self, path):
