...
* `hrl`: a high-resource language. This flag can be set to Hindi (`hin`), Turkish (`tur`), Italian (`ita`), Indonesian (`ind`), Modern Standard Arabic (`arb`), and Haitian Creole (`hat`)
...
* `flores_dir`: folder path to the FloRes-200 evaluation dataset.
* `kreyolmt_dir`: folder path to the Haitian Creole-related languages evaluation dataset. This is from [Kreyòl-MT: Building MT for Latin American, Caribbean and Colonial African Creole Languages](https://aclanthology.org/2024.naacl-long.170/).
